...
import 'package:food_recipe_app/core/presentation/component/icon_box.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          const Padding(
            padding: EdgeInsets.only(top: 54.0, left: 30.0),
            child: Text(
              'Create an account',
          ...
          BigButton(
            text: 'Sign Up',
            onPressed: () => widget.onSignupTap?.call(),
          ),
          Padding(
